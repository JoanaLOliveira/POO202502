...
public class Agenda {
    ...
    // Listar compromissos de um dia específico
    public void listaDia(int dia, int mes, int ano) {
        System.out.println("Compromissos em " + String.format("%02d/%02d/%04d", dia, mes, ano) + ":");
        ...
        if (!encontrado) {
            System.out.println("Nenhum compromisso nesse dia.");
        }
    }
}
